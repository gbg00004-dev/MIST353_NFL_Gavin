...
from get_teams_in_same_conference_division_as_specified_ui import get_teams_in_same_conference_division_as_specified_ui
from get_team_for_specified_fan import get_teams_for_specified_fan_ui
...
with st.sidebar:
    ...
    api_endpoint = st.selectbox(
        ...
        ["Get Teams by Conference and Division", "Get Teams in Same Conference and Division as Specified Team", "Get Teams for Specified Fan"]
    )
...
if api_endpoint == "Get Teams by Conference and Division":
    ...
    get_teams_in_same_conference_division_as_specified_ui()
